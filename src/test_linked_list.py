...
@pytest.mark.parametrize('iterable, linked_list_display', ITER_TABLE)
def test_init_optional_param(iterable, linked_list_display):
    list1 = LinkedList(iterable)
    assert list1.display() == linked_list_display
